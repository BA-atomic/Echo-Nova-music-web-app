...
//         <p class="faveArtist">${shortenText(currentSong.title, 7)}</p>
//         <p class="faveArtist">${shortenText(currentSong.artist, 7)}</p>
//       </div>
//     `;
...
//       songPoster.src = songData.cover;
//       currentTrackTitle.textContent = songData.title;
//       currentTrackArtist.textContent = songData.artist;
